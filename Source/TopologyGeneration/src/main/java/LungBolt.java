...
public class LungBolt extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(LungBolt.class);
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        try {
         String s = tuple.getString(0);
          /*  String r[] = s.split("_"); */
         String filename = "lung";
  /*          String features = r[1];
*/
         double[] feature = fromString(s);
            Boolean check = checkLung(feature);
    ...
    public Boolean checkLung(double[] feature) {
