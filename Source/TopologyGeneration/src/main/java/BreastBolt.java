...
public class BreastBolt extends BaseBasicBolt {
    private static final Logger LOG = LoggerFactory.getLogger(BreastBolt.class);
    public void execute(Tuple tuple, BasicOutputCollector basicOutputCollector) {
        try {
         String s = tuple.getString(0);
          /*  String r[] = s.split("_"); */
         String filename = "Breast";
  /*          String features = r[1];
*/
         double[] feature = fromString(s);
            Boolean check = checkBreast(feature);
    ...
    public Boolean checkBreast(double[] feature) {
